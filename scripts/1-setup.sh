...
if [[ ! $DESKTOP_ENV == server ]]; then
  sed -n '/'$INSTALL_TYPE'/q;p' $HOME/Arch123/pkg-files/pacman-pkgs.txt | while read line
  do
...
if ! source $HOME/Arch123/configs/setup.conf; then
...
echo "username=${username,,}" >> ${HOME}/Arch123/configs/setup.conf

    #Set Password
    read -p "Please enter password:" password
echo "password=${password,,}" >> ${HOME}/Arch123/configs/setup.conf
    ...
    echo "NAME_OF_MACHINE=${name_of_machine,,}" >> ${HOME}/Arch123/configs/setup.conf
fi
echo -ne "
-------------------------------------------------------------------------
                    Adding User
...
# use chpasswd to enter $USERNAME:$password
	...
	cp -R $HOME/Arch123 /home/$USERNAME/
    chown -R $USERNAME: /home/$USERNAME/Arch123
